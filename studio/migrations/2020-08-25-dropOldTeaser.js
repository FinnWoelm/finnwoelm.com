...
// Run this script with: `sanity exec --with-user-token migrations/dropOldTeaser.js`
//
...
const fetchDocuments = () =>
  client.fetch(`*[_type == 'post' && defined(teaser2)][0...100] {_id, _rev, teaser2}`)

const buildPatches = docs =>
  docs.map(doc => ({
      id: doc._id,
      patch: {
        set: {teaser: doc.teaser2},
        unset: ['teaser2'],
