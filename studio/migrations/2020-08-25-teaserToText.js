...
// Run this script with: `sanity exec --with-user-token migrations/teaserToText.js`
//
...
const fetchDocuments = () =>
  client.fetch(`*[_type == 'post' && !defined(teaser2)][0...100] {_id, _rev, teaser}`)

const buildPatches = docs =>
  docs.map(doc => {
    const teaserBlocks = (doc.teaser || []).find(block => block._type === 'block')
    const teaserText = teaserBlocks ? teaserBlocks.children
